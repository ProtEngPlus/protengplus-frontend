  ...
  return (
    isVisible && (
      <div
        ...
        tabIndex={-1}
        className="fixed top-0 right-0 left-0 z-[80] flex justify-center items-center w-full h-full bg-gray-900/50 mt-0"
      >
        <div className="space-y-5 place-items-center place-self-center w-[644px] place-content-center text-center">
          <div className="modal-container bg-pep-blue-light opacity-100 px-5 py-8 m-auto z-[100]">
            <Icon
