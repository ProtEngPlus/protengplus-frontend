...
} from "../Overlay/ProteinSequenceOverlay";
...
export default function MutationProteinSequenceSection({
  ...
  const [mutationResults, setMutationResults] = useState<
    MutationResultInterface[]
  >([]);
  const [isProteinSequenceVisible, setIsProteinSequenceVisible] =
    useState(false);
  const [currentMutationResult, setCurrentMutationResult] =
