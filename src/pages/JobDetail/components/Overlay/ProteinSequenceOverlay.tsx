      ...
      >
        <div className="space-y-5 place-items-center place-self-center w-[55%] place-content-center text-center">
          <div className="bg-pep-blue-light opacity-100 px-5 py-8 m-auto z-[100] space-y-8 rounded-lg">
            ...
            <div className="bg-white rounded-lg p-8 gap-x-3 gap-y-4 font-light text-center">
              <div className="space-y-4 flex flex-col items-center">
                ...
                <div className="items-center w-[90%] border border-pep-gray-border rounded-lg p-4 break-all leading-7">
                  {proteinSequence}
                </div>
              </div>
            </div>
