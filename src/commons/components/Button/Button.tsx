...
export default function Button({
  ...
  const baseStyles =
    "w-48 h-[3.125rem] rounded-md px-7 py-3 disabled:cursor-not-allowed disabled:bg-white disabled:text-black disabled:border disabled:border-pep-gray-border";
  const typeStyles = {
