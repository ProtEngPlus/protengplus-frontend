    ...
    isVisible && (
      ...
      >
        <div className="space-y-5">
          <div className="modal-container grid grid-cols-[2fr,3fr] bg-pep-blue-light opacity-100 px-8 py-5 gap-x-8 w-fit m-auto z-[70] text-center">
            <div className="place-items-start space-y-5 mt-14 bg-white p-3 rounded-xl h-fit">
